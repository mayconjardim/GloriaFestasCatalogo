...
namespace GloriaFestasCatalogo.Client.Services.CartService
{
    public class CartService
    {
        ...
        public async Task AddToCart(ProductDto product)
        {
            ...
            CartProduct existingCartItem = cart.FirstOrDefault(cp => cp.Product.Id == product.Id);
        ...
        public async Task UpdateCartItemQuantity(ProductDto product, int quantityChange)
        {
            var cart = await _localStorage.GetItemAsync<List<CartProduct>>("cart");
