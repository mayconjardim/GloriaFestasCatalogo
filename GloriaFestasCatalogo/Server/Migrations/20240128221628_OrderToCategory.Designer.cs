...
namespace GloriaFestasCatalogo.Server.Migrations
{
    ...
    [Migration("20240128221628_OrderToCategory")]
    partial class OrderToCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GloriaFestasCatalogo.Shared.Models.Config.AppConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GloriaFestasCatalogo.Shared.Models.Products.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("GloriaFestasCatalogo.Shared.Models.Products.ProductVariant", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ProductProductCategory", b =>
                {
                    ...
                    b.ToTable("ProductCategoryAssociation", (string)null);
                });
            ...
            modelBuilder.Entity("GloriaFestasCatalogo.Shared.Models.Products.ProductVariant", b =>
                {
                    ...
                    b.HasOne("GloriaFestasCatalogo.Shared.Models.Products.ProductType", "ProductType")
                        .WithMany()
            ...
            modelBuilder.Entity("ProductProductCategory", b =>
                {
                    b.HasOne("GloriaFestasCatalogo.Shared.Models.Products.ProductCategory", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GloriaFestasCatalogo.Shared.Models.Products.Product", null)
                        .WithMany()
